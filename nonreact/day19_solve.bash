...
REMAINDER1=$(psql --tuples-only --no-align --variable=PLAYER_COUNT=${ELF_COUNT} --variable=MODULUS=${MODULUS1} --file=${DIRNAME}/day19.sql)
REMAINDER2=$(psql --tuples-only --no-align --variable=PLAYER_COUNT=${ELF_COUNT} --variable=MODULUS=${MODULUS2} --file=${DIRNAME}/day19.sql)
